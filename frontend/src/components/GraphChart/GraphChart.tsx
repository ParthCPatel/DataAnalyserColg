            ...
            return (
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart {...CommonProps}>
                        ...
                        />
                        <Legend />
                        <Bar dataKey={yAxis} fill="#3b82f6" radius={[4, 4, 0, 0]} isAnimationActive={enableAnimation} />
                    </BarChart>
                </ResponsiveContainer>
            );
        case 'line':
            return (
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart {...CommonProps}>
                        ...
                        <Legend />
                        <Line type="monotone" dataKey={yAxis} stroke="#3b82f6" strokeWidth={2} dot={{ fill: '#3b82f6', r: 4 }} activeDot={{ r: 6 }} legendType="circle" isAnimationActive={enableAnimation} />
                    </LineChart>
                </ResponsiveContainer>
            );
        case 'area':
