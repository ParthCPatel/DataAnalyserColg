...
const Navbar: React.FC<NavbarProps> = ({ onOpenSidebar }) => {
    ...
    return (
        <div className="navbar-container" style={{
            ...
            right: 0,
            height: '64px',
            background: 'rgba(11, 23, 46, 0.95)', // Increased opacity
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                ...
                <button
                    ...
                    onMouseLeave={(e) => {
                        e.currentTarget.style.background = 'rgba(18, 30, 50, 0.6)';
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                ...
                <button
                    ...
                    style={{
                        background: isActive('/home') ? 'rgba(59, 130, 246, 0.1)' : 'rgba(255, 255, 255, 0.1)',
                        border: '1px solid',
                        ...
                        gap: '6px',
                        transition: 'all 0.2s',
                        boxShadow: isActive('/home') ? '0 0 10px rgba(59, 130, 246, 0.3)' : 'none'
                    }}
                    onMouseEnter={(e) => {
                        if (!isActive('/home')) {
                            e.currentTarget.style.borderColor = 'var(--accent-primary)';
